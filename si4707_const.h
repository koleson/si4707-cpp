...
#define SI4707_PROP_GPO_IEN =                    0x0001			// defaults to 0x0000
#define SI4707_PROP_REFCLK_FREQ =                0x0201			// defaults to 0x8000
#define SI4707_PROP_REFCLK_PRESCALE =            0x0202			// defaults to 0x0001
#define SI4707_PROP_RX_VOLUME =                  0x4000			// defaults to 0x003f
#define SI4707_PROP_RX_HARD_MUTE =               0x4001			// defaults to 0x0000
#define SI4707_PROP_WB_MAX_TUNE_ERROR =          0x5108			// defaults to 0x000a
#define SI4707_PROP_WB_RSQ_INT_SOURCE =          0x5200			// defaults to 0x0000
#define SI4707_PROP_WB_RSQ_SNR_HI_THRESH =       0x5201			// defaults to 0x007f
#define SI4707_PROP_WB_RSQ_SNR_LO_THRESH =       0x5202			// defaults to 0x0000
#define SI4707_PROP_WB_RSQ_RSSI_HI_THRESH =      0x5203			// defaults to 0x007f
#define SI4707_PROP_WB_RSQ_RSSI_LO_THRESH =      0x5204			// defaults to 0x0000
#define SI4707_PROP_WB_VALID_SNR_THRESH =        0x5403			// defaults to 0x0003
#define SI4707_PROP_WB_VALID_RSSI_THRESH =       0x5404			// defaults to 0x0014
#define SI4707_PROP_WB_SAME_INTERRUPT_SOURCE =   0x5500			// defaults to 0x0000
